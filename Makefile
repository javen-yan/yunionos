...
REGISTRY_HOST = "registry.cn-hangzhou.aliyuncs.com/transfer-images"
BUILD_ROOT_VERSION = "2021.08.2"
BUILD_ROOT_IMG = $(REGISTRY)/buildroot:$(BUILD_ROOT_VERSION)-0
YUNIONOS_VERSION = "v3.10.12-20240616.0"
...
KERNEL_ARM_6_DEB ?= linux-image-6.1.0-37-arm64_6.1.140-1_arm64.deb

#KERNEL_AMD64_6_DEB ?= linux-image-6.1.0-32-amd64_6.1.129-1_amd64.deb
KERNEL_AMD64_6_DEB ?= linux-image-6.1.0-37-amd64_6.1.140-1_amd64.deb
